...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 100, description: 'Minimum price filter' }),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 500, description: 'Maximum price filter' }),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
