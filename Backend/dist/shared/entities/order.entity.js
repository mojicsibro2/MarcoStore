...
const delivery_mode_entity_1 = require("./delivery-mode.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => delivery_mode_entity_1.DeliveryMode, { eager: true }),
    __metadata("design:type", delivery_mode_entity_1.DeliveryMode)
], Order.prototype, "deliveryMode", void 0);
__decorate([
